...
const VistaDetalladaD = () => {
  ...
  useEffect(() => {
    ...
    const handleView = async () => {
      try {
        const response = await fetch(`${backend_url}/obtenerDistribuidorID/${id}`, {
          method: "GET",
          credentials: "include",
        });
    ...
    <div className="d-flex flex-column align-items-center justify-content-center">
      <Card className="vista-detallada">
        ...
        <ListGroup className="list-group-flush align-items-center">
          ...
          <ListGroup.Item>Dirección: {clienteData?.dirrecion||""}</ListGroup.Item>
          <ListGroup.Item>Categoría: {clienteData?.categoria||""}</ListGroup.Item>
        </ListGroup>
        <Card.Body>
          {/* Contenido adicional según tus necesidades */}
        </Card.Body>
...
export default VistaDetalladaD;
